...
function calculate() {
  ...
  newEntry.innerHTML = `
    ...
    <span class="line">
      Prop Diameter: ${propDiameter}in, Prop Tip Speed MPH: ${tipSpeedMPH.toFixed(2)}, Mach: ${machNumber.toFixed(2)}, Stator Volume to Prop Area Ratio: ${volumeToAreaRatio.toFixed(2)} mm³/in²
    </span>
  `;
